...
* URL: http://localhost:8000/resourcesList
  ...
  * Attack: ``
  * Evidence: `select`
  * Other Info: `The following pattern was used: \bSELECT\b and was detected 2 times, the first in the element starting with: "<!--","resource_description":"want to reserve 2 cats"},{"resource_id":496,"resource_name":"]]>","resource_description":"want to ", see evidence field for the suspicious comment/snippet.`
...
localhost
session_id=12b21968-fa1b-46f0-a1b9-0af5e9294ade
`
...
* URL: http://localhost:8000/login
  ...
  * Attack: ``
  * Evidence: `12b21968-fa1b-46f0-a1b9-0af5e9294ade`
  * Other Info: `
cookie:session_id`
* URL: http://localhost:8000/login
  * Method: `GET`
